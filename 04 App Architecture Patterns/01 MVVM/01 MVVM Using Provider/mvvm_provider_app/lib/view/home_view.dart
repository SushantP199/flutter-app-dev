...
import 'package:mvvm_provider_app/data/response/status.dart';
import 'package:mvvm_provider_app/utils/routes/routes_name.dart';
import 'package:mvvm_provider_app/view_model/home_view_model.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text("MVVM | Architectural Pattern"),
          actions: [
            IconButton(
                onPressed: () {
